...
{
    internal class IdentityProvideJudgementTransaction : SpecificTransaction
    {
        ...
        public void Execute(int transactionId)
        {
            ...
            _dbAdapter.InsertIntoCall(fTransfer, new List<TableRow> { blockHash, tid, judgementValue, targetValue, transactionSenderKey, status, nonce, signatureKey, blocknumber });
        }
