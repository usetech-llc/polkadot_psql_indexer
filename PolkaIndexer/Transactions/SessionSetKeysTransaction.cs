...
{
    internal class SessionSetKeysTransaction : SpecificTransaction
    {
        ...
        public void Execute(int transactionId)
        {
            ...
            _dbAdapter.InsertIntoCall(transfer, new List<TableRow> { blockHash, tid, signatureKey, status, nonce, transactionSenderKey, keysRow, proofRow, blocknumber });
        }
