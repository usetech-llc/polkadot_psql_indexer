...
{
    internal class BalancesSetBalanceTransaction : SpecificTransaction
    {
        ...
        public void Execute(int transactionId)
        {
            ...
            _dbAdapter.InsertIntoCall(bsb, new List<TableRow> { blockHash, tid, status, nonce, signatureKey,  who, nFree, nReserved, blocknumber, transactionSenderKey });
        }
