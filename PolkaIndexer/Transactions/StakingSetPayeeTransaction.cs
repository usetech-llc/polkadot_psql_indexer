...
{
    internal class StakingSetPayeeTransaction : ISpecificTransaction
    {
        ...
        public void Execute(int transactionId)
        {
            ...
            _dbAdapter.InsertIntoCall(transfer, new List<TableRow> { tid, signatureKey, status, nonce, transactionSenderKey, payeeRow, blocknumber });
        }
