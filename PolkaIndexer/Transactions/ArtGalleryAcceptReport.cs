...
{
    internal class ArtGalleryAcceptReport : SpecificTransaction
    {
        ...
        public ArtGalleryAcceptReport(string module, string method) : base(module, method)
        {
        }
        ...
        {         
            ...
            var extendedinfoReportRow = new TableRow
            {
                ...
                Value = new List<string> { $"'{{Accepted}}'" }
            };
            ...
            var acceptReportCall = new TableName
            {
                MethodName = "accept_report",
                ModuleName = "ArtGalleryPallet"
            };
            ...
            _dbAdapter.InsertIntoCall(acceptReportCall, new List<TableRow> { blockHash, tid, status, blocknumber, nonce, signatureKey, transactionSenderKey, collectionIdRow, colRow, tokRow });
        }
        ...
        public override bool Parse(BlockHash bh, SignedBlock sb, string extrinsic)
        {
            ...
            try
            {
                ...
                if (moduleName.Equals("ArtGalleryPallet", StringComparison.InvariantCultureIgnoreCase) && 
                    methodName.Equals("accept_report", StringComparison.InvariantCultureIgnoreCase))
                    result = true;
            }
            catch (Exception)
            {
