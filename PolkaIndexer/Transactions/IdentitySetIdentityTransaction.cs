...
{
    internal class IdentitySetIdentityTransaction : ISpecificTransaction
    {
        ...
        public void Execute()
        {
            ...
            _dbAdapter.InsertIntoCall(fTransfer, new List<TableRow> { transactionSenderKey, status, nonce, signatureKey, infoRow, blocknumber });
        }
