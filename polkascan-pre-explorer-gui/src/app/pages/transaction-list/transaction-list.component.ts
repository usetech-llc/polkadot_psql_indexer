...
export class TransactionListComponent implements OnInit, OnDestroy {
  ...
  public addressFrom: string = null;
  ...
  getExtrinsics(page: number): void {
    ...
    if (this.addressFrom !== null && this.addressFrom.trim() != "") {
      // @ts-ignore
      params.remotefilter.address_from = this.addressFrom;
    }

    if (this.addressTo !== null && this.addressTo.trim() != "") {
      // @ts-ignore
      params.remotefilter.address_to = this.addressTo;
    }
